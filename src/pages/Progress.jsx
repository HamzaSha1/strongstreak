  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <div className="flex-1 flex items-center justify-center overflow-hidden px-2 pb-6">
          <img
            src={photo.photo_url}
            alt="Progress"
...
function CompareView({ a, b, onClose }) {
  return (
    ...
    >
      ...
      <div className="flex-1 flex gap-1 px-1 pb-6 overflow-hidden">
        {[a, b].map((photo, i) => (
...
export default function Progress() {
  ...
  const [compareSelected, setCompareSelected] = useState([]); // up to 2 weight objects
  ...
  // Photos-only list for comparison selection
  ...
  const toggleCompareSelect = (w) => {
    setCompareSelected((prev) => {
      ...
      if (prev.length >= 2) return [prev[1], w]; // swap oldest out
      return [...prev, w];
    });
  };
            ...
            <div className="bg-card border border-border rounded-2xl p-4">
              ...
              <div className="flex flex-col gap-3">
                {weights.map((w, idx) => {
                  ...
                  const isSelectable = compareMode && !!w.photo_url;
                  return (
                        ...
                        <div className="relative">
                          ...
                          >
                            <img
                              ...
                              alt="Progress"
                              className={cn(
                                'w-full h-40 object-cover rounded-lg transition-all',
                                isSelectable && 'active:opacity-80',
                          ...
                          {/* Tap to view hint (normal mode only) */}
                          {!compareMode && (
                            <div className="absolute bottom-2 right-2 bg-black/40 rounded-md px-2 py-0.5">
